...
_cffi_f_Cryptography_check_ansix923_padding(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 2, "Cryptography_check_ansix923_padding");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_Cryptography_check_pkcs7_padding(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 2, "Cryptography_check_pkcs7_padding");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__cryptography_padding(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__cryptography_padding(void) { return NULL; }
#  else
     init_cryptography_padding(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__cryptography_padding(void)
{
  return _cffi_init("_cryptography_padding", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_cryptography_padding(void)
{
  _cffi_init("_cryptography_padding", 0x2601, &_cffi_type_context);
}
#endif
